...
class CategoryDAO:
    DEFAULT_CATEGORIES = [
        ...
        {"name": "物理", "keywords": ["物理", "运动", "静止", "机械运动", "参照物", "相对运动", "速度", "加速度", "位移", "路程", "时间", "速率", "力", "重力", "弹力", "摩擦力", "浮力", "压力", "支持力", "质量", "密度", "体积", "力学", "牛顿", "惯性", "合力", "分力", "平衡", "杠杆", "滑轮", "斜面", "轮轴", "功", "功率", "机械效率", "热", "温度", "热量", "比热容", "内能", "热传递", "热机", "光", "光学", "透镜", "凸透镜", "凹透镜", "成像", "实像", "虚像", "反射", "折射", "镜子", "焦距", "物距", "像距", "电", "磁", "电路", "电流", "电压", "电阻", "欧姆", "电功", "电功率", "电热", "串联", "并联", "电场", "磁场", "电磁波", "电磁感应", "声", "声音", "噪声", "音调", "响度", "音色", "能量", "动能", "势能", "机械能", "守恒", "测量", "长度", "刻度尺", "游标卡尺", "螺旋测微器", "单位", "换算", "国际单位", "振动", "波", "原子", "核", "量子"], "color": "#3498db"},
